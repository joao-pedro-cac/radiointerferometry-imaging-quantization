...
TRUE_MODEL_PATH = "../data/simulated/point_field_ctrl/truth_model.fits"
...
experiment_commentary = "Comparing float64 x float32 x float16 x bfloat16. Recreating the 5 stars in the original sky model."
